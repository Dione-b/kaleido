...
Internal alpha release for Kaleido. This release validates the repository, template, CLI/core workflow, and the first `@kaleido-xlm/client` interop layer. It is not an npm publication milestone.
